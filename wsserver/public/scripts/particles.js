//Wait for the DOM to load and then load the particles
    ...
    tsParticles
      .load({
        ...
        options: {
          autoPlay: true,
          background: {
            image: "radial-gradient(circle, #30cfd0 -50%, #330867)",
            repeat: "no-repeat",
            size: "cover",
            opacity: 1,
          },
      ...
      .catch((error) => {
        console.error("Error in loading particles: " + error);
      });
  }, 1000);
});
